<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PorciKowi.aspx.cs" Inherits="CARTAPORTE.PorciKowi" %>
         ...
         <h2 >CARTA PORTE</h2>
                ...
                <div class="row" >
                        ...
                        <div  class="col-md-4">
                             ...
                             <asp:DropDownList class="form-control" ID="DDLEmpresa" runat="server" OnSelectedIndexChanged="DDLEmpresa_SelectedIndexChanged"></asp:DropDownList>
                        </div>
                        <div class="col-md-4">
