<%@ Page Title="-" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CARTAPORTE._Default" %>
...
function openModal() {
    ...
    $(function () {
    $("[id*=GridModal] input[type=checkbox]").click(function () {
    if ($(this).is(":checked")) {
    $("[id*=GridModal] input[type=checkbox]").removeAttr("checked");
    ...
    <div class="row">
        <div  class="col-auto mr-auto">
                    ...
                    <div class="row" >
                        ...
                        <asp:DropDownList class="form-control" ID="DDLEmpresa" AutoPostBack="true" runat="server" OnSelectedIndexChanged="DDLEmpresa_SelectedIndexChanged"></asp:DropDownList>
    ...
    <div class="row">
                <div class="col-md-4">
           CHOFER <asp:DropDownList ID="DDLOperador" class="form-control" AutoPostBack="true" runat="server" OnSelectedIndexChanged="DDLOperador_SelectedIndexChanged"></asp:DropDownList>
        </div>
        <div class="col-md-4">
    ...
    <div class="row">
               ...
               FECHA LLEGADA <asp:TextBox textmode="Date" class="form-control" ID="TxtFechallegada" runat="server"></asp:TextBox>
                 ...
                 <div class="col-md-4">
              TIPO PERMISO SCT
            <asp:DropDownList ID="DDLTipoPermiso" class="form-control" runat="server" >
            </asp:DropDownList>
        </div>
         <div class="col-md-4">
              VEHICULO
            <asp:DropDownList ID="DDLAuto"  required="required" class="form-control" runat="server" >
            </asp:DropDownList>
        </div>
    </div>
    <br />
        <div class="row">
        <div class="col-md-4">
             DESCRIPCION DE VEHICULO<asp:DropDownList ID="DDLConfVehi"  required="required" class="form-control" runat="server"></asp:DropDownList>
        </div>
      <!--    <div class="col-md-4">
              TIENE REMOLQUE
            <asp:DropDownList ID="DDLRemolqueSN"  required="required" class="form-control" runat="server"  AutoPostBack="true" OnSelectedIndexChanged="DDLRemolqueSN_SelectedIndexChanged">
            </asp:DropDownList>
        </div>-->
         <div class="col-md-4">
     ...
     <asp:requiredfieldvalidator id="RequiredFieldValidator4"
      ...
      <div class="row">
          ...
          <asp:Button ID="BtnDelet" class="btn btn-danger" runat="server" Text="BORRAR" Width="205px" OnClick="BtnDelet_Click"  />
            ...
            <asp:Button ID="Button1" class="btn btn-success" runat="server" Text="GENERAR DOCUMENTO" Width="232px" OnClick="Button1_Click1" />
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <asp:GridView ID="GridModal"  class="table table-bordered table-condensed table-hover" runat="server" OnPageIndexChanging="GridModal_PageIndexChanging">
                  <Columns>
        <asp:TemplateField>
            <ItemTemplate>
